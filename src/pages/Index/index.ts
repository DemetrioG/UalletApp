...
export function Index(props) {
  ...
  return (
    <View
      style={[
        general().containerCenter,
        general().padding,
        general(props.theme).backgroundColor,
      ]}
    >
      <Carousel
        data={slides}
      ...
      />
      <TouchableOpacity
        style={general(null, metrics.smallMargin).button}
      ...
      <TouchableOpacity
        style={[
          general(props.theme, metrics.smallMargin).buttonOutline,
          styles().buttonLogin,
        ]}
